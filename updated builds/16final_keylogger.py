...
def is_file_uploaded(file_path):
    ...
    """
    global data_uploaded_cache
    return file_path in data_uploaded_cache

# Function to mark a file as uploaded
def mark_file_uploaded(file_path):
    """
    Adds the file to the uploaded cache.
    """
    global data_uploaded_cache
    data_uploaded_cache.add(file_path)
