...
CURRENT_VERSION = "1.1.1" # current version of program
...
DEFAULT_UPLOAD_INTERVAL = 100 # 10 minutes
DEFAULT_FALLBACK_INTERVAL = 20
# FALLBACK_INTERVAL = 300 # 5 minutes
# DEFAULT_FALLBACK_INTERVAL = 300
...
# def fetch_upload_interval(url, default_interval=DEFAULT_UPLOAD_INTERVAL):
#     """
#     Fetches the upload interval from the provided URL. Falls back to the default interval on failure.
#     """
#     try:
...
#             return int(data["upload_interval"])
#         else:
#             logging.error("Key 'upload_interval' not found in the JSON response.")
#             print("Key 'upload_interval' not found in the JSON response.")
#     except requests.exceptions.RequestException as e:
#         logging.error(f"Network error while fetching upload interval: {e}")
#         print(f"Network error while fetching upload interval: {e}")
...
def upload_logs():
    ...
    while True:  # Infinite loop for continuous execution
        ...
        # upload_interval = fetch_upload_interval(INTERVAL_URL, DEFAULT_UPLOAD_INTERVAL)
